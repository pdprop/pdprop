C  plateLongSurfFlaw.f   vers. 2.23   Notched Spec Crack Prop.  FAC jan 6 2013
      SAVE
...
C---------------------------  Run time input data------------------
  184 continue
      write(6,185)
      write(0,185)
  185 format("# plateLongSurfFlaw.f vers. 2.23"/
...
Css      clsts90(1) =-abs(sobj90)
      tldam90(1)   =dam90
      tltotCrk90(1)=totdam90
      itlnrev90(1) =nrev
      cldam90(1)   =dam90
      cltotCrk90(1)=totdam90
      iclnrev90(1) =nrev
