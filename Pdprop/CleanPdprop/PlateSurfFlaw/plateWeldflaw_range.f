C  plateWeldflaw_range.f   vers. 1.21   Notched Spec Crack Prop.  FAC jan.06 2013
      SAVE
...
Css     &  ,tlstr90(4000), clstr90(4000),tlsts90(4000),clsts90(4000)
     ...
     & ,tltotCrk00(4000),cltotCrk00(4000)
...
C---------------------------  Run time input data------------------
  184 continue
      write(6,185)
      write(0,185)
  185 format("# plateWeldflaw_range.f vers. 1.21"/
...
C      write(6,120) nrev,totdam90,totdam00,nblk,nact,lobj90,lobj00,
C     &             xfw
C  120 format("#crkdat=",i9,2(1x,e14.7),i9,1x,i6,2(1x,f10.5),
C     &             1x,f10.7
C     &      )
