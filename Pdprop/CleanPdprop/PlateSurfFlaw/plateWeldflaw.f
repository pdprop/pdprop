C  plateWeldflaw.f   vers. 2.24   Notched Spec Crack Prop.  FAC feb.28 2013
      SAVE
...
C---------------------------  Run time input data------------------
  184 continue
      write(6,185)
      write(0,185)
  185 format("# plateWeldflaw.f vers. 2.24"/
...
C     Often too much output.  Turn this off of isavelevel <3
...
Css      clsts00(1) =-abs(sobj00)
      tldam00(1) =dam00
      tltotCrk00(1)=totdam00
      itlnrev00(1) =nrev
      cldam00(1) =dam00
      cltotCrk00(1)=totdam00
      iclnrev00(1) =nrev
