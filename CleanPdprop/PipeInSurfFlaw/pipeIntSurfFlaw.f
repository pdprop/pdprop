C pipeIntSurfFlaw.f   vers. 4.2  Notched Spec Crack Prop.  FAC aug 23 2018
      SAVE
...
C vers 4.2 Fix 2nd pt read bug in getPeakLoads()  s/r   Aug. 23 2018
...
C---------------------------  Run time input data------------------
  184 continue
      write(6,185)
      write(0,185)
  185 format("# pipeIntSurfFlaw.f vers. 4.2"/
...
C     Get the second point   stspres  to create the initial line.
  100 continue
      n=n+1
Cbug  Fixed  2nd read point bug here.  Aug 2018
