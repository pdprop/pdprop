...
Csubr      SUBROUTINE fwSurfFlaw(ivec,iret,cow,aob,xfw)
      SAVE
...
Csubr      if(ivec.eq.1)go to 3000  !go and interpolate
...
C     One row is done, write it out for the table
 ...
 2000 continue
      ...
      write(0,*)"# Finished creating fw Matrix "
Csubr     iret=0
Csubr     return
